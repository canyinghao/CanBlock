...
public class CanRecyclerViewPager extends RecyclerView {
    ...
    public static void setTabLayoutSupport(@NonNull final TabLayout tabLayout
            , @NonNull final CanRecyclerViewPager viewPager
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                viewPager.smoothScrollToPosition(tab.getPosition());
            }
